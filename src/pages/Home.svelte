...
<main class="bg-green-50">
  ...
  <div class="text-skin-base focus:outline-none h-full w-full flex flex-col space-y-16 items-center justify-start mb-8 px-4 md:px-16">
      ...
      <div class="w-full lg:flex-grow-0 flex-grow grid auto-rows-max gap-8 lg:gap-4 lg:mr-4 lg:mt-8 lg:pr-16 items-stretch justify-around justify-items-stretch text-left">
        ...
        <div on:click="{setLoginForm}" class="row-span-1 mt-8 flex lg:flex-row flex-col space-y-4 lg:space-y-0 justify-start">
          ...
          <div class="sm:mt-0 sm:ml-3">
            <a href="/demo" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-stone-700 bg-stone-100 hover:bg-stone-200 md:py-4 md:text-lg md:px-10"> Live demo </a>
          </div>
        </div>
      </div>
    ...
    <section id="pricing" class="my-auto w-full flex flex-col items-center justify-center">
      <h1 class="mb-6 text-8xl text-stone-700/30 font-serif font-bold">Pricing</h1>
      <div class="w-full grid grid-rows-1 items-center md:items-start justify-items-center gap-8 md:gap-24">
        <div class="flex flex-col items-center justify-center">
          <h3 class="text-lg sm:text-xl md:text-2xl font-serif font-bold">Scalable Peer</h3>
          <h1 class="text-5xl sm:text-6xl md:text-8xl font-serif font-bold text-center">
            $1 <span class="text-lg sm:text-xl md:text-2xl text-stone-700"> / week</span>
          </h1>
          <h3 class="text-4xl font-serif font-bold text-center block">50 peer-min included</h3>
          <h6 class="text-base font-normal font-mono">overage charges $1 per 50 peer-min</h6>
          <div class="w-full flex flex-col content-start">
            <div class="w-full flex-grow md:w-11/12 p-4 m-auto">
              <div class="w-full rounded-2xl bg-stone-50 overflow-hidden shadow">
                <div class="w-full px-4 py-2 bg-green-200 text-stone-700 text-4xl font-serif font-bold text-center"></div>
                  ...
                  <div class="w-full flex flex-col lg:flex-row">
                    <div class="w-full lg:w-1/2 px-6 md:px-12 py-4 text-stone-700">
                      <div class="flex flex-col">
                        ...
                        <span class="text-stone-500 text-sm font-mono"> This cost will be charged each week, as a fee for using the service. </span>
                      </div>
                    </div>
                    ...
                    <div class="w-full lg:w-1/2 m-auto lg:m-0 px-6 md:px-12 py-4 bg-green-100 flex flex-col">
                      <span class="text-stone-700 text-2xl font-mono font-bold"> $1/week</span>
                    </div>
                  </div>
                  ...
                  <div class="w-full flex flex-col lg:flex-row">
                    <div class="w-full lg:w-1/2 px-6 md:px-12 py-4  text-stone-700 flex flex-col">
                      ...
                      <span class="text-stone-500 text-sm font-mono">
                        <a href="#consumer">Based on peer-min, a room created for 20 minutes with 2 peers is 40 peer-min. Similarly, 20 rooms each having 2 peers, and a duration of 20 minutes sums upto 800 peer-min</a>
                      </span>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mx-6 md:mx-12 lg:mx-2 text-stone-700 rotate-90 lg:rotate-0 -my-2 lg:my-auto z-10" viewBox="0 0 20 20" fill="currentColor">
                      <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                    ...
                    <div class="w-full lg:w-1/2 m-auto lg:m-0 px-6 md:px-12 py-4 bg-green-100 text-stone-700 flex flex-col">
                      <span class="text-stone-700 text-2xl font-mono font-bold">$1 per 50 peer-min</span>
                      <span class="text-stone-500 text-sm font-mono"> For a 25 minute room, $1 (25 x 2 x 0.02) will be charged. </span>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div class="w-full md:w-11/12 flex md:flex-row flex-col p-4 m-auto space-y-4 md:space-y-0 md:space-x-4">
              <div class="md:w-1/2 space-y-1 py-4 bg-stone-50 text-stone-800 rounded-2xl shadow">
                <div class="w-full px-4 md:px-8 py-1 flex flex-col space-y-2">
                  <div class="flex flex-row items-stretch justify-between content-between">
                    <label for="roomCount" class="text-stone-700 text-base font-serif font-bold">number of rooms created</label>
                    <span class="text-stone-700 text-lg font-serif font-bold">{rc}</span>
                  </div>
                  <input
                    name="roomCount"
                    type="range"
                ...
                <div class="w-full px-4 md:px-8 py-1 flex flex-col space-y-2">
                  <div class="flex flex-row items-stretch justify-between content-between">
                    <label for="userCount" class="text-stone-700 text-base font-serif font-bold">peers in a single room</label>
                    <span class="text-stone-700 text-lg font-serif font-bold">{uc}</span>
                  </div>
                  <input
                    name="userCount"
                    type="range"
                ...
                <div class="w-full px-4 md:px-8 py-1 flex flex-col space-y-2">
                  <div class="flex flex-row items-stretch justify-between content-between">
                    <label for="roomDuration" class="text-stone-700 text-base font-serif font-bold">room duration</label>
                    <span class="text-stone-700 text-lg font-serif font-bold">{rd} minutes</span>
                  </div>
                  <input
                    name="roomDuration"
                    type="range"
              ...
              <div class="md:w-1/2 py-4 flex flex-col space-y-1 bg-stone-50 text-stone-800 rounded-2xl shadow">
                <div class="w-full px-4 md:px-8 py-1 flex flex-row items-stretch justify-between content-between">
                  <span class="text-stone-500 text-base font-mono uppercase">total peer-min</span>
                  <span class="text-stone-500 text-lg font-mono">{nn(peerMin)}</span>
                </div>
                <div class="w-full px-4 md:px-8 py-1 flex flex-row items-stretch justify-between content-between">
                  <span class="text-stone-700 text-base font-serif font-bold">Weekly Subscription Charge</span>
                  <span class="text-stone-700 text-lg font-serif font-bold">$1</span>
                </div>
                <div class="w-full px-4 md:px-8 py-1 flex flex-row items-stretch justify-between content-between">
                  <span class="text-stone-700 text-base font-serif font-bold">Overage Charge</span>
                  <span class="text-stone-700 text-lg font-serif font-bold">{charge > 1 ? `$ ${nn(charge - 1)}` : `-`}</span>
                </div>
                <div class="w-full px-4 md:px-8 py-1 flex flex-row items-stretch justify-between content-between">
                  <span class="text-stone-700 text-base font-serif font-bold">Total Charge</span>
                  <span class="text-stone-700 text-lg font-serif font-bold">$ {nn(charge > 1 ? charge : 1)}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div on:click="{setLoginForm}" class="row-span-1 my-8 flex flex-col sm:flex-row justify-start items-center space-y-4 sm:space-y-0 sm:space-x-4">
        <div class="rounded-md shadow">
          <button class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 md:py-4 md:text-lg md:px-10"> Get started </button>
        </div>
        <div class="rounded-md shadow">
          <a href="/docs" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-stone-700 bg-stone-100 hover:bg-stone-200 md:py-4 md:text-lg md:px-10"> Check our Docs </a>
        </div>
      </div>
    </section>
  </div>
