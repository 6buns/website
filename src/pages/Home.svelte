...
<main>
  ...
  <div
        ...
        <div
          ...
          <div class="px-0 md:px-12 w-full md:w-[484px]">
            ...
            <p class="w-full px-0 md:pr-4 py-2">
              We use single forwarding unit architecture to provide the live
              live video conference or audio conference service. Get started
              with our api, choose <span class="font-bold">M2M</span> as architecture
              type, and add live video chat or audio chat feature to your application.
            </p>
    ...
    <section
      ...
      <div
        class="w-full grid grid-rows-2 md:grid-cols-2 md:grid-rows-1 items-center md:items-start justify-items-center gap-8 md:gap-24">
        <div class="w-full flex flex-col items-center justify-center">
          ...
          <h1
            ...
            $0.002 <span class="text-lg sm:text-xl md:text-2xl block"
              >per consumer-min</span>
          </h1>
          <div
          ...
          <div
            ...
            <p class="w-full text-base break-words">
              Each user has 2 consumers (1 video stream, 1 audio stream) per
              user * 3 users,
            </p>
            ...
            <p class="w-full text-base break-words">
              total consumers handled by the media server, for a room of 4
              users,
            </p>
            <h1 class="font-mono text-xl px-4 text-center bg-green-200">
              4 * 6 = 24 consumers
        ...
        <div class="w-full flex flex-col items-center justify-center">
          ...
          <h1
            class="text-5xl sm:text-6xl md:text-8xl font-serif font-bold text-center">
            $0.05 <span class="text-lg sm:text-xl md:text-2xl block"
              >per room</span>
          </h1>
          <div
            class="w-full md:w-96 my-4 flex flex-col items-start justify-evenly space-y-4">
    ...
    <section
      ...
      <h1
        class="bg-green-200 rounded-xl px-6 py-2 mb-6 text-4xl font-serif font-bold">
