...
<main
  style="{`--currentIndex:${statesArray.findIndex((x) => x === $current)};`}">
  <svg
    class="w-[360px] md:w-[480px]"
    ...
    {#if $currentIndex === 3}
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg">
        <path
          d="M0.226497 6L6 11.7735L11.7735 6L6 0.226497L0.226497 6ZM181.774 5.99999L176 0.226483L170.226 5.99999L176 11.7735L181.774 5.99999ZM6 7L176 6.99999L176 4.99999L6 5L6 7Z"
          fill="#292524"></path>
      </svg>
    {/if}
    ...
    {#if $currentIndex < 3}
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg">
        <path
          d="M12.3334 23.0417C12.3334 30.3163 23.3779 36.2083 37 36.2083C50.6222 36.2083 61.6667 30.3163 61.6667 23.0417C61.6667 15.7671 50.6222 9.875 37 9.875C23.3779 9.875 12.3334 15.7671 12.3334 23.0417Z"
          fill="#A8A29E"></path>
        <path
          ...
          fill="#C4C4C4"></path>
        <path
          d="M12.3334 39.5V55.9583C12.3334 63.2329 23.3779 69.125 37 69.125C50.6222 69.125 61.6667 63.2329 61.6667 55.9583V39.5C61.6667 46.7746 50.6222 52.6667 37 52.6667C23.3779 52.6667 12.3334 46.7746 12.3334 39.5Z"
          fill="#C4C4C4"></path>
        <path
      ...
      <div id="status" class="flex flex-col items-center justify-center">
        {#each ["userLive", "user1Server", "user2Server", "user1User2Connect"] as item (item)}
          {#if $current.match(item)}
            <p
              class="text-[10px] w-[150px] h-[50px] font-sans font-bold capitalize break-words text-center">
              {texts[$current]}
            </p>
          {:else}
            <p
