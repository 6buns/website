...
<div class="flex flex-row items-center justify-items-start ">
  ...
  <div class="ml-4 max-w-[224px] w-full h-full flex flex-col items-center justify-items-center space-y-4">
    <div class="relative w-full h-full bg-stripes-red text-red-500 flex flex-col items-center justify-center rounded-2xl overflow-hidden">
      ...
      <video class="object-cover h-full w-full m-[0_-50px_0_0]" src="./videos/01.mp4" style="transform: rotateY(180deg) scale(1.3);" autoplay loop muted></video>
    </div>
    <div class="relative w-full h-full bg-stripes-blue text-blue-500 flex flex-col items-center justify-center rounded-2xl overflow-hidden">
      ...
      <h1 class="text-center font-bold absolute bottom-0 right-0 left-0 text-white z-30" style="text-shadow: 1px 2px 2px #00000040;">Other Player</h1>
      <video class="object-cover h-full w-full scale-[1.2] m-[0_0_0_-30px]" src="./videos/02.mp4" autoplay loop muted></video>
    </div>
    <div class="w-full h-12 py-4 bg-stone-200 flex flex-col items-center justify-evenly space-x-4 rounded-2xl overflow-hidden">
      <div class="w-max flex flex-row items-center justify-center rounded-md px-4 hover:bg-stone-200 cursor-pointer py-1">
