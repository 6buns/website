<div>
  <div class="grid grid-cols-2 gap-4 items-center justify-items-center ">
    ...
    <div class="w-full h-full bg-stripes-yellow text-yellow-500 flex flex-col items-center justify-center rounded-2xl overflow-hidden">
      <div class="w-36 h-36 flex flex-col justify-center items-center ">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd"></path>
        </svg>
    ...
    <div class="w-full h-full bg-stripes-blue text-blue-500 flex flex-col items-center justify-center rounded-2xl overflow-hidden">
      <div class="w-36 h-36 flex flex-col justify-center items-center ">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd"></path>
        </svg>
