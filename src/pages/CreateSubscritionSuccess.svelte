...
<div class="w-full h-full -my-4 flex flex-col items-center justify-center">
  <div
    ...
    <h3
      class="col-span-2 mb-4 text-center text-6xl text-green-500 font-serif font-bold">
      Subscription to Single plan successful!
    </h3>
    <form
      ...
      <button
        ...
        type="submit">Manage your billing information</button>
    </form>
  </div>
</div>
